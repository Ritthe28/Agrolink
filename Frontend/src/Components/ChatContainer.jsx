...
}} src={assets.arrow_icon} className='md:hidden max-w-7' alt="" />
...
{messagesDummyData.map((msg, index)=>(
  <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId!=="680f50e4f10f3cd28382ecf9" &&"flex-row-reverse"}`}>
    {msg.image?<img className='max-w-[230px] border bg-gray-700 rounded-lg overflow-hidden mb-8 ' src={msg.image} />
    :
...
<div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
  ...
  >
    ...
    <label  htmlFor="image"><img className='cursor-pointer' src={assets.gallery_icon} alt="" /></label>
  </div>
